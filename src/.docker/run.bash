...
while getopts ":cstxhirp:" option; do
  case $option in
    ...
    r) # With internal graphics card (without nvidia) and with RDP. 
      ...
      ROCKER_ARGS="--devices /dev/dri $JOY --x11 --git \
      --port "$HOST_RDP_PORT":3389 \
      --port 14551:14551/udp \
      --port 14550:14550/udp \
      --port 5760:5760/tcp \
      --volume "$HOME":/home/docker/HOST";;
